...
<h2>ค้นหาศิษย์จากชื่อนักศึกษา</h2>
	<div class="container">
		<div class="boxid">
			<center>
				<div class="searchid">
					<form method="get" action="../Alumni/search_Name">
						<td>ชื่อ - นามสกุล นักศึกษา  :
							<input name="Name_LastName" type="text" size="30" maxlength="50" />
						</td>
